...
@Component
public class PostViewEventListener extends AbstractEventListener<PostViewEvent> implements MessageListener {
    ...
    public void onMessage(Message message, byte[] pattern) {
        PostViewEvent postEvent = handleEvent(message, PostViewEvent.class);
        AnalyticsEvent entity = analyticsEventMapper.toEntity(postEvent);
        entity.setEventType(EventType.POST_VIEW);
