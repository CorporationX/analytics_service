...
@Component
public class CommentCreateEventListener extends AbstractEventListener<CommentEvent> {
    ...
    public void onMessage(Message message, byte[] pattern) {
        ...
        analyticsEventService.saveEvent(analyticsEventMapper.toEntity(event, EventType.POST_COMMENT));
    }
}
