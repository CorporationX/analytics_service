...
public class AnalysisCommentsKafkaConsumerConfig {
    ...
    @Bean("concurrentKafkaListenerContainerFactoryAnalysisComments")
    public ConcurrentKafkaListenerContainerFactory<String, Object> concurrentKafkaListenerContainerFactory(
            @Qualifier(value = "analyticsConsumerFactory") ConsumerFactory<String, Object> analyticsConsumerFactory) {
