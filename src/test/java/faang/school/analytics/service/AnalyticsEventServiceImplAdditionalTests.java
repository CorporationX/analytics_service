...
public class AnalyticsEventServiceImplAdditionalTests {
    ...
    void savePremiumBoughtEvent_shouldSaveEvent() {
        ...
        premiumBoughtEvent.setSubscriptionDuration(12);
        premiumBoughtEvent.setPurchaseDateTime(LocalDateTime.now());
        ...
        assertEquals(premiumBoughtEvent.getPurchaseDateTime(), capturedEvent.getReceivedAt());
    }
}