...
class AnalyticsEventServiceImplTest {
  ...
  void testGetAnalytics() {
    ...
    doReturn(Stream.of(analyticsEvent)).when(analyticsEventRepository)
    ...
    doReturn(Stream.of(analyticsEvent, analyticsEvent, analyticsEvent)).when(analyticsEventFilter)
        .apply(any(), any(AnalyticsEventFilterDto.class));
